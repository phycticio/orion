...
class Orion_Options_Page {
	...
	public static function init(): void {
		...
		add_action( 'save_post_' . self::POST_TYPE, [
			'orion\actions\admin\post_types\Orion_Options_Page',
			'save_post'
		] );
	}
	...
	public static function register_post_type(): void {
		...
		$args   = Custom_Post_Type::args( [
			...
			'graphql_single_name' => 'custom_option_page',
			'graphql_plural_name' => 'custom_option_pages',
		] );
		register_post_type( self::POST_TYPE, $args );
	}

	public static function save_post( $post_id ): void {
		remove_action( 'save_post_' . self::POST_TYPE, [
			'orion\actions\admin\post_types\Orion_Options_Page',
			'save_post'
		] );
		wp_update_post( [
